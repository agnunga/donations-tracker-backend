...
import io.omosh.dts.dtos.daraja.B2cResult;
...
public class DonationController {
    ...
    public ResponseEntity<AcknowledgeResponse> paymentResult(@RequestBody B2cResult serviceResponse) throws JsonProcessingException {
